...
class FeedbackProfileForm(forms.ModelForm):
  class Meta:
    model = Feedback
    fields = ['name','city','feedback']
    widgets = {'name':forms.TextInput(attrs={'class':'form-control'}),'city':forms.TextInput(attrs={'class':'form-control'}),'feedback':forms.TextInput(attrs={'class':'form-control'})}
